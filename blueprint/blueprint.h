...
/** Config: BLUEPRINT_INCLUDE_UNIT_TESTS
    ...
    Includes unit tests into your project. By default this is off.
*/
#ifndef BLUEPRINT_INCLUDE_UNIT_TESTS
    #define BLUEPRINT_INCLUDE_UNIT_TESTS 0
#endif
...
/** This is a hacky workaround for an issue introduced in the YG_ENUM_BEGIN macro in YGMacros.h.

    When compiled on VS2017 we fall to their definition of YG_ENUM_BEGIN in YGMacros.h,
    which runs into something like a wrap-around overflow with signed types,
    and ends up trying to index with a garbage value into  an array.

    We overwrite the YG_ENUM_BEGIN definition here with an unsigned type and everything seems to work ok.
