    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Calls RawTextView::setText on the requested View.
            If the ViewId supplied is not the id of a RawTextView  this is a no-op.
        */
        ...
        /** Recursively computes the shadow tree layout on the root ShadowView,
            then traverses the tree flushing new layout bounds to the associated view components.
         */
        void performRootShadowTreeLayout();

        /** Empties the internal view tables, deallocating every view
            except the root in the ViewManager heirarchy.
        */
    ...
    private:
        ...
        /** Walks the view table, returning the first view with
            a `refId` whose value equals the provided id.
        */
