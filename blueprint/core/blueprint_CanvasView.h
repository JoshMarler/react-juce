...
namespace blueprint
{
    ...
    public:
        ...
        explicit CanvasContext()
            : ctxWidth(1), ctxHeight(1), image(juce::Image::ARGB, ctxWidth, ctxHeight, true)
        {
    ...
    private:
        ...
        {
            setProperty("__setFillStyle", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("__setStrokeStyle", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 1);
            ...
            setProperty("__setLineWidth", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 1);
             ...
             * */
            setProperty("__setFont", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 1);
            ...
            setProperty("__setTextAlign", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 1);
        ...
        void registerNativeFunctions()
        {
            ...
            setProperty("fillRect", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 4);
            ...
            setProperty("strokeRect", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 4);
            ...
            setProperty("strokeRoundedRect", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("fillRoundedRect", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 5);
            ...
            setProperty("clearRect", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 4);
            ...
            // Path functions
            setProperty("beginPath", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("lineTo", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("moveTo", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 2);
                            juce::ignoreUnused(args);
            ...
            setProperty("arc", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("quadraticCurveTo", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 4);
            ...
            setProperty("closePath", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 0);
                            juce::ignoreUnused(args);
            ...
            setProperty("stroke", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 0);
                            juce::ignoreUnused(args);
            ...
            setProperty("fill", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 0);
                            juce::ignoreUnused(args);
            ...
            // Transforms
            setProperty("rotate", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 1);
            ...
            setProperty("translate", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 2);
            ...
            setProperty("setTransform", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("resetTransform", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments == 0);
                            juce::ignoreUnused(args);
            ...
            // drawImage support
            setProperty("drawImage", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            // Text functions
            setProperty("strokeText", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
            ...
            setProperty("fillText", juce::var::NativeFunction{ [=](const juce::var::NativeFunctionArgs& args) -> juce::var {
                            jassert(graphics);
                            jassert(args.numArguments >= 3 && args.numArguments <= 4);
