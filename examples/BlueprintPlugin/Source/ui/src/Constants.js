...
export const ParamLabels = {
  ...
  [ParamIds.MIX]: 'MIX',
  [ParamIds.GRAIN_FREQUENCY]: 'FREQUENCY',
  [ParamIds.SPRAY]: 'SPRAY',
  [ParamIds.REVERSE]: 'REVERSE',
  [ParamIds.SPREAD]: 'SPREAD',
  [ParamIds.PITCH]: 'PITCH',
  [ParamIds.FEEDBACK_G1G2]: 'FEEDBACK',
  [ParamIds.GRAIN_FREQUENCY_G2]: 'FREQUENCY',
  [ParamIds.SPRAY_G2]: 'SPRAY',
  [ParamIds.REVERSE_G2]: 'REVERSE',
  [ParamIds.SPREAD_G2]: 'SPREAD',
  [ParamIds.PITCH_G2]: 'PITCH',
  [ParamIds.FEEDBACK_G2G1]: 'FEEDBACK',
};
